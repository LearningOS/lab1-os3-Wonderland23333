...
// //! 
// //! things about task management, like starting and switching tasks is implemented here
// //! 
// //! A single global instance of [`TaskManager`] called `TASK_MANAGER` controls all the 
// //! tasks in the os.
